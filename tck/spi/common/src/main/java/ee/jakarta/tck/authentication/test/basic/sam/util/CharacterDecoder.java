 ...
 * </pre>
 *
 * Of course in the simplest encoding schemes, the buffer has no distinct prefix of suffix, however all have some fixed
 * relationship between the text in an 'atom' and the binary data itself.
 *
 ...
 * </DL>
 *
 * In general, the character decoders return error in the form of a CEFormatException. The syntax of the detail string
 * is
 *
 * <pre>
...
public abstract class CharacterDecoder {
    ...
    /**
     * This method should return, if it knows, the number of bytes that will be decoded. Many formats such as uuencoding
     * provide this information. By default we return the maximum bytes that could have been encoded on the line.
     */
    ...
    /**
     * This method post processes the line, if there are error detection or correction codes in a line, they are generally
     * processed by this method. The simplest version of this method looks for the (newline) character.
     */
