...
public class ACFTestServlet extends HttpServlet {
    ...
    private boolean verifyRegistrations(AuthConfigFactory acf) {
        ...
        try {
            ...
            AuthConfigProvider servletACP = acf.getConfigProvider(JASPICData.LAYER_SERVLET, servletAppContext, null);

            if (servletACP != null) {
                if (servletACP.getClass().getName().equals("com.sun.ts.tests.jaspic.tssv.config.TSAuthConfigProviderServlet")) {
