...
public class TSServerAuthModule implements jakarta.security.auth.message.module.ServerAuthModule {
    ...
    public void initialize(MessagePolicy requestPolicy, MessagePolicy responsePolicy, CallbackHandler handler, Map options)
        ...
        logger.log(Level.INFO, "CBH for HttpServlet supports type: " + handler.getClass().getName());
    }
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject) throws AuthException {
        ...
        /*
         * // XXXX: bug fix for bug: 12880835 if (bIsMandatory) { Principal principal = new SimplePrincipal("j2ee", "j2ee");
    ...
    private String getRequestURI(MessageInfo messageInfo) {
        ...
        if ((reqObj != null) && (reqObj instanceof jakarta.servlet.http.HttpServletRequest)) {
    ...
    private void dumpServletProfileKeys(MessageInfo msgInfo, String callerMethod) {
        ...
        /*
         * // see assertion JASPI:SPEC:306 for details on this // jsr-196 states the following key must exist for servlet
         * profile String strKey = "jakarta.security.auth.message.MessagePolicy.isMandatory"; if (map != null) { String keyVal =
         * (String)map.get(strKey); String msg = "dumpServletProfileKeys() called with attrs: "; msg += " layer=" +
         * JASPICData.LAYER_SERVLET; msg += " servletName=" + servletName; msg += " callerMethod=" + callerMethod; msg +=
         * " key=" + strKey;
         * 
         * if (keyVal == null) { msg += " value=NULL"; } else if (Boolean.valueOf(keyVal).booleanValue() == true) { msg +=
         * " value=Valid"; } else { msg += " value=Invalid value of: " + keyVal; } logger.log(Level.INFO, msg); }
         */
                ...
                if (oKey instanceof String) {
                    ...
                    if (key != null) {
                        ...
                        if (obj instanceof String) {
                            ...
                            logger.log(Level.INFO, "Map key is of type :" + obj.getClass().getName());
                        }
                    }
                }
            }
        ...
        if (messageInfo != null) {
            ...
            if (respObj != null) {
                ...
                if (respObj instanceof jakarta.servlet.http.HttpServletResponse) {
                    ...
                    /*
                     * if (requestURI != null) { // this should have been obtained from the requestObj above msg = msg +" for requestURI=" +
                     * requestURI; }
                     */
                } else {
                    msg = msg + messageInfo.getClass().getName();
