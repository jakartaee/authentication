 ...
 * scenario when a profile other than Servlet/SOAP is being defined and used with JSR 196.
 *
 * At the time of this test creation, the 2 main supported profiles are SOAP and Servlet. But it is very possible that
 * someone may use JSR-196 to define their own profiles. For that case, we need to have something we can use for the
