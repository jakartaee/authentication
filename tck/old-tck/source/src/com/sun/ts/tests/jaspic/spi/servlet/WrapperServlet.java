...
public class WrapperServlet extends HttpServlet {
    ...
    /*
     * This is used to initialize our logger so that we can log from this servlet into the TSSVLog.txt file. This will allow
     * us to test verifyRuntimeCallOrder() (from in Client.java)
     */
