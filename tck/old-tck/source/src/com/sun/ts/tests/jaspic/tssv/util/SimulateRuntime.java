...
public class SimulateRuntime {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AuthConfigProvider acp = acf.getConfigProvider(JASPICData.LAYER_SOAP, "JSR196Context", rlis);

            // Get AuthConfigProvider
            AuthConfigProvider acp2 = acf.getConfigProvider(JASPICData.LAYER_SOAP, "JSR196Context-2", rlis);

            // Get ServerAuthConfig
            ServerAuthConfig serverAuthConfig = acp2.getServerAuthConfig(JASPICData.LAYER_SOAP, "JSR196Context", cbh);
            ...
            ClientAuthConfig clientAuthConfig = acp2.getClientAuthConfig(JASPICData.LAYER_SOAP, "JSR196Context", cbh);
            ...
            servletACP = acf.getConfigProvider(JASPICData.LAYER_SERVLET, "/spitests_servlet_web/ModTestServlet", rlis);
            ...
            sac = servletACP.getServerAuthConfig(JASPICData.LAYER_SERVLET, "/spitests_servlet_web/ModTestServlet", cbh);
            ...
            servletACP2 = acf.getConfigProvider(JASPICData.LAYER_SERVLET, "/spitests_servlet_web/SecondaryTestServlet", rlis);

        } catch (Exception e) {
            e.printStackTrace();
        }

        System.out.println("Simulation Over, Created Log file :" + logFileLocation + "/" + JASPICData.DEFAULT_LOG_FILE);
    }

    /*
     * Acceptable Servlet profile operationID should resemble a String in the format of: request.getServletPath() +
     * request.getPathInfo() + "%20" + request.getMethod()
     *
     */
