...
interview. Properties that can be changed are identified in the Maven pom.xml file of the test module.
Apart from changing such properties and other allowed
